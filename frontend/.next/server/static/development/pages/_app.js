...
var _jsxFileName = "/Users/Aereli/Desktop/Full-Course/Advanced-React/Boutique/frontend/components/Header.js";
...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;text-align:center;a{padding:0.5rem 1rem;background:", ";color:white;color:", ";text-decoration:none;@media(max-width:1300px){margin:0;grid-template-columns:1fr;text-align:center;}}"], function (props) {
...
})([".bar{border-bottom:10px solid ", ";display:grid;grid-template-columns:auto 1fr;justify-content:space-between;align-items:stretch;@media(max-width:1300px){grid-template-columns:1fr;justify-content:center;}}.sub-bar{display:grid;grid-template-columns:1fr;border-bottom:2px solid ", "}"], function (props) {
  return props.theme.blue;
}, function (props) {
  return props.theme.salmon;
});
...
var Header = function Header() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(StyledHeader, {
    ...
    __self: this
  }, "Boutique"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Nav__WEBPACK_IMPORTED_MODULE_1__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64
    },
...
var _jsxFileName = "/Users/Aereli/Desktop/Full-Course/Advanced-React/Boutique/frontend/components/Meta.js";
...
var _jsxFileName = "/Users/Aereli/Desktop/Full-Course/Advanced-React/Boutique/frontend/components/Nav.js";
...
var _jsxFileName = "/Users/Aereli/Desktop/Full-Course/Advanced-React/Boutique/frontend/components/Page.js";
...
})(["margin:0;padding:0;display:flex;justify-self:end;font-size:2rem;a,button{padding:1rem 3rem;display:flex;align-items:center;position:relative;text-transform:uppercase;font-weight:900;font-size:1em;background:none;border:0;cursor:pointer;@media (max-width:700px){font-size:10px;padding:0 10px;}&:before{content:'';width:3px;background:", ";height:100%;left:0;position:absolute;top:0;bottom:0;}&:after{height:3px;background:", ";content:'';width:0;position:absolute;transform:translateX(-50%);transition:width 0.4s;transition-timing-function:cubic-bezier(1,-0.65,0,2.31);left:50%;margin-top:2rem;}&:hover,&:focus{outline:none;&:after{width:calc(100% - 60px);}@media (max-width:700px){width:calc(100% - 10px);}}}@media (max-width:1300px){border-top:3px solid ", ";width:100%;justify-content:center;font-size:1.5rem;}"], function (props) {
  return props.theme.beiche;
}, function (props) {
  return props.theme.salmon;
}, function (props) {
  return props.theme.beiche;
...
var _jsxFileName = "/Users/Aereli/Desktop/Full-Course/Advanced-React/Boutique/frontend/pages/_app.js";
  ...
  _createClass(Myapp, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_app__WEBPACK_IMPORTED_MODULE_2__["Container"], {
        ...
        client: apollo_boost__WEBPACK_IMPORTED_MODULE_6__["ApolloClient"],
        __source: {
          fileName: _jsxFileName,
          lineNumber: 22
        },
